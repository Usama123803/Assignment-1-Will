            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer_box">
                        <img src="Modules/Assets/images/footer_logo.png" alt="Footer Logo">
    ...
    <!-- Ajax Included -->
    <script src="Modules/Assets/js/jquery.min.js"></script>
    <script src="Modules/Assets/source/jquery.fancybox.pack.js"></script>
    <script src="Modules/Assets/js/bootstrap.min.js"></script>
    <script src="Modules/Assets/js/owl.carousel.min.js"></script>
    <script src="Modules/Assets/js/waypoint.js"></script>
    <script src="Modules/Assets/js/jquery.counter.min.js"></script>
    <script src="Modules/Assets/js/magnific.min.js"></script>
    <script src="Modules/Assets/js/custom.js"></script>
</body>
</html>