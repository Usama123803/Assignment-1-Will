...
<html lang="en">
    <head>
        ...
        <link href="Modules/Backend/assets/plugins/morris-chart/morris.css" rel="stylesheet">
        <!-- Theme Css -->
    ...
    <body class="sticky-header">
                ...
                <div class="sidebar-left-info">
                    ...
                    <div class="user-box">
                        <div class="d-flex justify-content-center">
                            <img src="Modules/Backend/assets/images/users/avatar-1.jpg" alt="" class="img-fluid rounded-circle"> 
                        </div>
                    ...
                    <ul class="side-navigation">
                        ...
                        <li class="menu-list"><a href=""><i class="mdi mdi-buffer"></i> <span>UI Elements</span></a>
                            <ul class="child-list">
                                <li><a href="Modules/Backend/00 Original/ui-typography.html"> Typography</a></li>
                            ...
                            <ul class="notification-menu">
                                ...
                                <li>
                                    <a href="javascript:;" data-toggle="dropdown">
                                        <img src="Modules/Backend/assets/images/users/avatar-1.jpg" alt="">
                                    </a>
                                    ...
                                    <div class="online-chat-container">
                                        ...
                                        <ul class="team-list chat-list-side">
                                            <li>
                                                <a href="#" class="ml-3">
                                                    <span class="thumb-small">
                                                        <img class="rounded-circle" src="Modules/Backend/assets/images/users/avatar-1.jpg" alt="">
                                            ...
                                            <li>
                                                <a href="#" class="ml-3">
                                                    <span class="thumb-small">
                                                        <img class="rounded-circle" src="Modules/Backend/assets/images/users/avatar-3.jpg" alt="">
                                                        <i class="online dot"></i>
                                                    </span>
                                                    <div class="inline">
                                            ...
                                            <li>
                                                <a href="#" class="ml-3">
                                                    <span class="thumb-small">
                                                        <img class="rounded-circle" src="Modules/Backend/assets/images/users/avatar-4.jpg" alt="">
                                                        <i class="away dot"></i>
                                                    </span>
                                                    <div class="inline">
                                            ...
                                            <li>
                                                <a href="#" class="ml-3">
                                                    <span class="thumb-small">
                                                        <img class="rounded-circle" src="Modules/Backend/assets/images/users/avatar-5.jpg" alt="">
                                                        <i class="busy dot"></i>
                                                    </span>
                                                    <div class="inline">
                                            ...
                                            <li>
                                                <a href="#" class="ml-3">
                                                    <span class="thumb-small">
                                                        <img class="rounded-circle" src="Modules/Backend/assets/images/users/avatar-6.jpg" alt="">
                                                         <i class="online dot"></i>
                                                    </span>
                                                    <div class="inline">
                                        ...
                                        <ul class="list-unstyled friends">
                                            <li>
                                                <a href="#">
                                                    <img class="rounded-circle" src="Modules/Backend/assets/images/users/avatar-7.jpg" alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img class="rounded-circle" src="Modules/Backend/assets/images/users/avatar-8.jpg" alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img class="rounded-circle" src="Modules/Backend/assets/images/users/avatar-9.jpg" alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img class="rounded-circle" src="Modules/Backend/assets/images/users/avatar-10.jpg" alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img class="rounded-circle" src="Modules/Backend/assets/images/users/avatar-2.jpg" alt="">
                                                </a>
                                            </li>
                                             <li>
                                                <a href="#">
        ...
        <script src="Modules/Backend/assets/pages/dashboard-init.js"></script>
